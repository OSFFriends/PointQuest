defmodule PointQuestWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PointQuestWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PointQuestWeb.Gettext, "errors", msg, opts)
    end
  end
